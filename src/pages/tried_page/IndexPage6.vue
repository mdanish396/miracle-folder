  ...
  <transition name="fade" mode="out-in">
    ...
    <q-header class="q-pa-md navigation-bar" elevated :class="{ visible: scrolled, transparent: !scrolled }">
      ...
      <div class="nav-buttons q-mr-md" v-if="!isSmallScreen">
        <q-btn flat label="About Miracle" to="/about-us"/>
        <q-btn flat label="DEVELOPMENT" @mouseover="showDropdown" @mouseleave="hideDropdown"/>
        ...
        <q-btn flat label="For Sale" to="/for-sale"/>
        <q-btn flat label="For Lease" to="/for-lease"/>
        <q-btn flat label="Awards" to="/awards"/>
        <q-btn flat label="Investor & Media" to="/investor-media"/>
      </div>
